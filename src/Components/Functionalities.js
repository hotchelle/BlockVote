...
const Functionalities =  () => {
  ...
  const connectToWallet = async () => {
    try{
      ...
      console.log("connectToWallet ran")
  ...
  const createPoll = async (pollName) => {
    try{
      ...
      console.log("Poll successfull created")
  ...
  const getVotes = async (pollName) => {
    ...
    setVotes(votes)
    console.log(votes)
    console.log("Successfully retrieved votes")
    return votes
  }
